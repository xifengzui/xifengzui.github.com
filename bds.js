...
var BaiduSuggestion = (function() {
    ...
    var J = {
        createSugOptions: function(S, R, Q, P) {
            return {
                ...
                append_html: "<div style='background:#FFF;line-height:normal;border:0;text-align:right;margin:0;padding:0;'><a class='bdsug_copy' href='https://arkis.me/' ltarget='_blank' ></a></div>",
                apd_body: true
            }
        },
    ...
    function A() {
        ...
        L(".bdsug_copy", "margin:0;background:transparent url(https://home.arkis.me/favicon16x16.ico) no-repeat;font-size:13px;color:#16a085;text-decoration:none;padding:0 2px 0 16px;")
    }
    A();
